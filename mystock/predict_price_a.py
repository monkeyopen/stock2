...
def predict_price(dataset="a_stock_follow",
                  model_weights_path="model/mse_side_loss_a_stock_price_step50_1_20180101_20231231_last.pth",
...
if __name__ == '__main__':
    ...
    for model_weights_path in model_weights_path_list:
        result = predict_price(dataset="a_stock_follow", model_weights_path=model_weights_path,
                               flag=False, label_type="price", start_date="20240201",
                               end_date="20241231")
