...
if __name__ == '__main__':
    model_weights_path_list = [
        "random",
        "model/log_cosh_loss_a_stock_price_step50_1_20180101_20231231_last.pth",
        "model/mse_loss_a_stock_price_step50_1_20180101_20231231_last.pth",
        "model/l1_loss_a_stock_price_step50_1_20180101_20231231_last.pth",
        "model/smooth_l1_loss_a_stock_price_step50_1_20180101_20231231_last.pth",
        "model/huber_loss_a_stock_price_step50_1_20180101_20231231_last.pth",
        "model/mse_side_loss_a_stock_price_step50_1_20180101_20231231_last.pth"]
    result_list = []
    label_file = CONF_PATH + "a_stock_test2"
        ...
        with open(label_file, 'r') as f:
            for line in f.readlines():
                ...
                mse, mae, acc, profit = test_price_stock(stock=stock, model_weights_path=model_weights_path,
                                                         flag=False, label_type="price", start_date="20231201",
                                                         end_date="20241231")
                result_list.append((model_weights_path[:], stock, mse, mae, acc, profit))
    ...
    for result in sorted_model:
        print(f"{result[0]}: acc={result[3]:.4f}, profit={result[4]:.4f}")
        # mse = {result[1]: .4f}, mae = {result[2]: .4f},
