...
def test_sell(dataset="us_stock_test2", model_weights_path="model/sell_240_step100_20130101_20231231_last.pth",
    ...
    with open(label_file, 'r') as f:
        ...
        if flag:
            ...
            for i in range(len(predictions)):
                print(
                    f"output {output[i].item():.2f}, Pre {predictions[i].item()}, Label {labels_tensor[i].item()}, {info_np[i]}")
...
if __name__ == '__main__':
    model_weights_path_list = [
        "model/us_stock_sell1_step100_05_20210101_20231231_100.pth",
        "model/hk_stock_sell1_step100_05_20180101_20231231_100.pth",
        "model/us_stock_sell1_step100_05_20210101_20231231_300.pth",
        "model/us_stock_sell1_step100_05_20210101_20231231_400.pth",
        "model/us_stock_sell1_step100_05_20210101_20231231_500.pth",
        "model/us_stock_sell1_step100_05_20210101_20231231_last.pth",
        "model/us_stock_sell1_step100_05_20180101_20231231_100.pth",
        "model/us_stock_sell1_step100_05_20180101_20231231_200.pth",
        "model/us_stock_sell1_step100_05_20180101_20231231_300.pth",
        "model/us_stock_sell1_step100_05_20180101_20231231_400.pth",
        "model/us_stock_sell1_step100_05_20180101_20231231_500.pth",
        "model/us_stock_sell1_step100_05_20180101_20231231_last.pth"]
    result_list = []
    for model_weights_path in model_weights_path_list:
        acc, recall = test_sell(dataset="hk_stock", model_weights_path=model_weights_path,
                                flag=False, label_type="sell1", start_date="20240101",
                                end_date="20241231")
        result_list.append((model_weights_path, f"{acc * 100:.2f}%", f"{recall * 100:.2f}%"))
